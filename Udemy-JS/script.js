...
const miniPrice = randomPrices.reduce((min, price) => (price < min ? price : min));

console.log(`The minimum price is $${miniPrice}.`); // $1.72
...
console.log(`The minimum number is ${findMinValue([4, 102, 8, 37, 89])}.`); // 4
